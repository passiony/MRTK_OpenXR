...
namespace Microsoft.MixedReality.OpenXR.Sample
{
    ...
    public class ARAnchorWorldLocking : MonoBehaviour
    {
        ...
        [SerializeField] private Transform m_Adjustment;

        public Pose FrozenFromPinned
        {
            get { return m_Adjustment.GetGlobalPose(); }
        }
        ...
        public void SetOffsetPose(Pose pos)
        {
            m_Adjustment.SetGlobalPose(FrozenFromPinned.Multiply(pos));
            ...
            var anchor = AddAnchor(m_Adjustment.GetGlobalPose());
        ...
        {
            Debug.Log("恢复世界锚");
            m_Adjustment.SetGlobalPose(visualAnchor.transform.GetGlobalPose());
        }
